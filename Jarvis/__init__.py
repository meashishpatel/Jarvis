...
from Jarvis.features import openSubwaySurfers
...
class JarvisAssistant:
    ...
    def mic_input(self):
        ...
        try:
            ...
            with sr.Microphone() as source:
                self.tts("Listening...")  # Speak "Listening..."
                print("Listening....")
                r.energy_threshold = 4000
                audio = r.listen(source)
            try:
                self.tts("Recognizing...")  # Speak "Recognizing..."
                print("Recognizing...")
                command = r.recognize_google(audio, language='en-in').lower()
                print(f'You said: {command}')
            except:
                self.tts("Please try again")  # Speak "Please try again"
    ...
    def temple_run(self):
        return openGame.start()
    
    def subway_surfers(self):
        return openSubwaySurfers.start()
    ...
    def battery_info(self):
        return system_stats.battery_stats()
